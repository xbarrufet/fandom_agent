...
from tools.helpers import get_text_from_brackets
...
def lookup_40k_character_url(name:str,verbose=False) -> str:
    ...
    template = """dado el personaje {character} que aparece en la wiki fandom quiero que me devuelvas solamente la url de la pagina que contiene su informacion."""
    ...
    tools_for_agent = [
        Tool(
            name = "Buscador de url de personajes en la wiki fandom",
    ...
    return get_text_from_brackets(fandom_url)
